      ...
      <div className="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-2 lg:order-1">
          ...
          <p className="lab-body text-lg mb-8">
            Hardware-integrated soil monitoring with AI insights
            for precision elachi cultivation excellence.
          </p>
        ...
        <div className="order-1 lg:order-2">
          <div className="lab-card max-w-md mx-auto">
            ...
            <p className="text-center text-gray-600 mb-8">Sign in to your dashboard</p>
